    ...
    <div class="jumbotron">
        <div class="container-fluid">
            <div class="header-content-inner">
                ...
                <h3>Aqui, cada visita é um momento para desfrutar de sabores genuínos em um ambiente que abraça a todos.</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="hov-img">
                        ...
                        <div class="hov-img-top hov-img-slideup">
                            <div class="hov-img-text">
                                <h5>Mesas</h5>
                                <p>Nossas mesas foram cuidadosamente dispostas para criar um ambiente acolhedor e elegante, projetado para acomodar tanto encontros íntimos quanto celebrações animadas.</p>
                            </div>
                        </div>
                    </div>                    
                    ...
                    <div class="hov-img">
                        ...
                        <div class="hov-img-top hov-img-slideup">
                            <div class="hov-img-text">
                                ...
                                <p>Mesas confortáveis, estrategicamente posicionadas junto às paredes, para oferecer um refúgio acolhedor para os apreciadores da boa comida e da boa companhia.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-7">
                    <div class="row ">
                        <div class="restaurant-historia slideanim text-center">
                            ...
                            <button type="button" class="btn mais" id="mais" data-toggle="collapse" data-target="#demo">Mais</button>
                            <div id="demo" class="collapse">  
                                <p class="sobre-historia">Ao entrar na Cantina Federal, você é recebido por uma 
                                    ...
                                    minimizar nosso impacto ambiental, adotando práticas sustentáveis sempre que possível.</br>
            ...
            <div class="row mais-img">
                    ...
                    <div class="to-galeria">
                        ...
                        <div class="social-networks">
                            <a href="https://www.instagram.com/cantina_federal/" target="_blank" class="instagram"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-6 contato-right" >
                            ...
                            <form novalidate action="mailto:anttnew@gmmmail.com" name="frm" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" id="comentario" placeholder="Deseja comentar algo?"></textarea>
                                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="footer-items">
                        <address>
                                ...
                                <br>
                                <i class="fa fa-envelope address"></i> <a href="mailto:cantinafederal@gmail.com">cantinafederal@gmail.com</a>
                        </address>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
