            ...
            <div id="signup-tab-content" class="active">
                <form class="form_cadastro" action="cadastroclientes.php" method="POST">
                    ...
                    <input type="email" class="input" id="user_email" autocomplete="off" placeholder="Email"
                        name="email" required>
                    <input type="text" class="input" id="user_cidade" autocomplete="off" placeholder="Cidade"
                        name="cidade" required>
                    <input type="text" class="input" id="user_bairro" autocomplete="off" placeholder="Bairro"
